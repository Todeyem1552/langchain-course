...
def main():
    ...
    summary_template = '''
    Given the information in {information} about a person, I want you to: 
    1. provide a concise summary of the key points about Elon Musk's life, career, and controversies. The summary should be no more than 150 words.
